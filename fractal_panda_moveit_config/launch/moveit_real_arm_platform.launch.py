...
def generate_launch_description():
    ...
    # planning_context
    fractal_panda_xacro_file = os.path.join(
        get_package_share_directory('fractal_panda_description'),
        'urdf',
        'fractal_panda.urdf.xacro',
    )
    robot_description_config = Command(
        [FindExecutable(name='xacro'), ' ', fractal_panda_xacro_file, ' hand:=', load_gripper,
         ' robot_ip:=', robot_ip, ' use_fake_hardware:=', use_fake_hardware,
         ' fake_sensor_commands:=', fake_sensor_commands, ' planning_mode:=true'])
