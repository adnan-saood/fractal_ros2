...
#include "test_fractal_pad_controller.hpp"
...
using fractal_pad_controller::CMD_MY_ITFS;
using fractal_pad_controller::control_mode_type;
using fractal_pad_controller::STATE_MY_ITFS;

class FractalPadControllerTest : public FractalPadControllerFixture<TestableFractalPadController>
{
};

TEST_F(FractalPadControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(FractalPadControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(FractalPadControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(FractalPadControllerTest, update_success)
{
  SetUpController();
...
TEST_F(FractalPadControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(FractalPadControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(FractalPadControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(FractalPadControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(FractalPadControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(FractalPadControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(FractalPadControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
